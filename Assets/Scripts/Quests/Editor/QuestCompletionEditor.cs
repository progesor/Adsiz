...
namespace ProgesorCreating.Quests.Editor
{
    [CustomEditor(typeof(QuestCompletion))]
    public class QuestCompletionEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                foreach (Objective questObjective in selectedQuest.GetObjectives())
                {
